...
class NOMADExtension(cast.analysers.ua.Extension):

    def __init__(self):        
        self.extensions = ['.nomad']
        self.active = False
        self.nbpgmCreated = 0
    ...
    def start_file(self,file):  
        ...
        if ext.lower() in self.extensions:
            ...
            log.info("Parsing NOMAD file %s..." % file)
            ...
            with open_source_file(file.get_path()) as srcfile1:
                ...
                self.obj = self.__create_object(self,obj_name, "NOMADProgram", self.file, self.filepath, obj_bookmark)
                self.nbpgmCreated += 1
    ...
    def end_analysis(self):
        ...
        log.info("*****************************************************************")
        log.info(" Total NOMAD Program Objects Created  -- > " + str(self.nbpgmCreated))
        log.info("*****************************************************************")
